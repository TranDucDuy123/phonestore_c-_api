    ...
    public class AccountController : GlobalController
    {
        ...
        public IActionResult Login(LoginViewModel usr)
        {
            ...
            if (u != null)
            {
                ...
                // Sau khi người dùng đăng nhập thành công và xác thực qua cookie
                HttpContext.Session.SetString(Const.ADMINIDSESSION, u.Id.ToString());  // Lưu ID người dùng vào session
