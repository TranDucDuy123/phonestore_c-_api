...
namespace DoAn2VADT.Migrations
{
    ...
    [Migration("20241224120613_AddBaseEntityColumnsToVNPayTransaction")]
    partial class AddBaseEntityColumnsToVNPayTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoAn2VADT.Database.Entities.Color", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DoAn2VADT.Database.Entities.Coupon", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnOrder(1);
            ...
            modelBuilder.Entity("DoAn2VADT.Database.Entities.Notification", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnOrder(1);
            ...
            modelBuilder.Entity("DoAn2VADT.Database.Entities.ProductColor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DoAn2VADT.Database.Entities.VNPayTransaction", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnOrder(1);
            ...
            modelBuilder.Entity("DoAn2VADT.Database.Entities.ProductColor", b =>
                {
                    b.HasOne("DoAn2VADT.Database.Entities.Color", "Color")
                        .WithMany()
